...
class OrganizationMembersControllerTest < ActionController::TestCase
  ...
  test "should create organization_member" do
    assert_difference('OrganizationMember.count') do
      post :create, organization_member: { member_type_id: @organization_member.member_type_id, organization_id: @organization_member.organization_id, user_id: @organization_member.user_id }
    end
  ...
  test "should update organization_member" do
    patch :update, id: @organization_member, organization_member: { member_type_id: @organization_member.member_type_id, organization_id: @organization_member.organization_id, user_id: @organization_member.user_id }
    assert_redirected_to organization_member_path(assigns(:organization_member))
  end
